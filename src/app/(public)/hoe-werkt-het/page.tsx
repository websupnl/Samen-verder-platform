...
export default function HoeWerktHetPage() {
  const stappen = [
    { icon: UserPlus, title: "1. Aanmelden", description: "Maak een account aan als ouder of als buddy. Vul je profiel in zodat we weten wie je bent en wat je zoekt." },
    { icon: Search, title: "2. Matchen", description: "Ons systeem of een beheerder kijkt naar overeenkomsten in behoeften, interesses en locatie." },
    { icon: Handshake, title: "3. Kennismaken", description: "Er vindt een eerste gesprek plaats (vaak met een professional erbij) om te kijken of er een klik is." },
    { icon: Heart, title: "4. Samen Verder", description: "Als het klikt, gaan jullie samen aan de slag. Jullie bepalen zelf hoe en wanneer jullie contact hebben." },
  ];
      ...
      <section className="py-12 md:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative">
            ...
            <Stagger className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
              {stappen.map((stap, i) => (
