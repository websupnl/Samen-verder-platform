...
const modules = [
  { nr: "01", title: "Luisteren en verbinding maken", text: "Hoe geef je iemand echt het gevoel dat hij gehoord wordt? Je leert actief luisteren, doorvragen en aanwezig zijn zonder je eigen mening op te dringen." },
  { nr: "02", title: "Het systeem begrijpen", text: "Uithuisplaatsing, OTS, Raad voor de Kinderbescherming: wat betekent dat allemaal? Je krijgt een helder beeld van de betrokken instanties en procedures." },
  { nr: "03", title: "Grenzen en zelfzorg", text: "Hoe blijf je betrokken zonder te verzanden? Je leert herkennen wanneer iets te zwaar wordt en hoe je je eigen grenzen bewaakt." },
  { nr: "04", title: "Privacy en vertrouwelijkheid", text: "Als buddy hoor je gevoelige informatie. Je leert wat je daarmee mag en hoe je veilig en discreet omgaat met wat je weet." },
  { nr: "05", title: "Omgaan met emoties", text: "Ouders kunnen verdriet, boosheid of wantrouwen uiten. Je leert daar rustig en constructief mee omgaan, zonder te oordelen." },
  { nr: "06", title: "Praktijk en terugkoppeling", text: "Via rollenspellen en casusbesprekingen oefen je situaties die je als buddy kunt tegenkomen. Daarna bespreek je die samen." },
];

const steps = [
  { step: "1", title: "Aanmelding en intake", text: "Je meldt je aan als buddy. We plannen een kennismakingsgesprek om te kijken of het past en wat je verwachtingen zijn." },
  { step: "2", title: "Online voorbereiding", text: "Je doorloopt een aantal korte online modules in je eigen tempo. Zo kom je goed voorbereid de bijeenkomst in." },
  { step: "3", title: "Trainingsbijeenkomst", text: "Een halve dag samen met andere nieuwe buddies. Praktijk, casusbesprekingen, vragen stellen en kennismaken." },
  { step: "4", title: "Koppeling en start", text: "Na de training word je gekoppeld aan een ouder. Jouw begeleider blijft beschikbaar voor vragen en terugkoppeling." },
];
    ...
    <div className="flex flex-col w-full">
      ...
      <section className="py-12 md:py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <ScaleIn className="relative h-80 rounded-3xl overflow-hidden shadow-xl">
              <Image
      ...
      <section className="py-12 md:py-24 bg-sage-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <Stagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {modules.map((m) => (
              <StaggerItem key={m.nr}>
                <div className="bg-white rounded-2xl border border-sage-100 p-6 h-full">
      ...
      <section className="py-12 md:py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <Stagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {steps.map((s) => (
          ...
          <FadeUp delay={0.1} className="bg-primary/5 border border-primary/10 rounded-3xl p-8 md:p-12">
            ...
            <FadeUp>
              ...
              <ul className="space-y-4 mb-8">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3 text-sage-700">
      ...
      <section className="py-12 md:py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeUp className="bg-sage-900 text-white rounded-3xl p-8 md:p-16 text-center">
