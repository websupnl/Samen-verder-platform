        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <Stagger className="grid grid-cols-1 gap-6">
              {[
                { icon: Heart, title: "Warmte & Begrip", text: "Geen oordeel, alleen oprechte aandacht voor uw situatie." },
                { icon: MessageCircle, title: "Altijd Bereikbaar", text: "Via het platform kunt u veilig en makkelijk communiceren." },
                { icon: Shield, title: "Veilig & Vertrouwd", text: "Al onze buddies zijn gescreend en getraind." },
                  ...
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <h3 className="font-bold text-sage-900">{title}</h3>
                          <p className="mt-1 text-sage-600">{text}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
