      ...
      <main className="flex-1 overflow-y-auto min-w-0">
        <header className="h-16 bg-white border-b border-sage-100 flex items-center justify-between px-4 md:px-8 sticky top-0 z-30">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-semibold text-sage-900 text-sm md:text-base">Welkom terug, Maria</h2>
          </div>
          <div className="h-8 w-8 rounded-full bg-sage-200 flex items-center justify-center font-bold text-sage-600 text-sm">M</div>
        </header>
